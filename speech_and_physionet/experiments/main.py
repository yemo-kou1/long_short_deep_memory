...
parser.add_argument('--name_task', type=str, default='sepsis',
                    choices=['speech_commands', 'sepsis', 'uea'])
parser.add_argument('--work_dir', default='save_logs', type=str,
                    help='where to save model ckpt.')
parser.add_argument('--model_name', type=str, default='odernn')
parser.add_argument('--seed', default=1, type=int, help='Seed.')

parser.add_argument('--hidden_channels', default=160, type=int,
                    help='hidden size. for both LSTM and Trafo.')
parser.add_argument('--hidden_hidden_channels', default=4, type=int,
                    help='hidden size. for both LSTM and Trafo.')
...
parser.add_argument('--trafo_ff_dim', default=64, type=int,
...
parser.add_argument('--batch_size', default=1024, type=int,
                    help='batch size.')
parser.add_argument('--base_lr', default=6e-5, type=float,
...
# task specific
parser.add_argument('--use_sepsis_intensity', action='store_true', default=False,
