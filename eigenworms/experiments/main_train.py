...
parser.add_argument('--model_type', default='multilayerlsdm', type=str)
...
parser.add_argument('--hidden_dim', help='hidden dim', default=40, type=int)
...
parser.add_argument('--learning_rule', default='delta')
parser.add_argument('--num_heads', default=16, type=int)
parser.add_argument('--trafo_ff_dim', help='if None x4', default=64)
...
# Save best values to metrics and history to fil
