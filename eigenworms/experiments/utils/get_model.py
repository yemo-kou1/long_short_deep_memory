...
from experiments.odelstm.odeLstm import LSTMode
from experiments.odelstm_new.odeLstm import ActivateLSDM, MultilayerLSDM
...
def get_model(model_type,
    ...
    def model_getter(hidden_dim, hidden_hidden_dim=None):
        ...
        elif model_type == 'odelstm':
            model = ActivateLSDM(input_dim, hidden_dim, output_dim)
        elif model_type == 'multilayerlsdm':
            model = MultilayerLSDM(input_dim, output_dim, [int(hidden_dim/2), hidden_dim, hidden_dim])
        else:
