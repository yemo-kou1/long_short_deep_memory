...
def process_data(ds_folder='UEA', ds_name='EigenWorms', missing_rate=None, include_observational_intensity=False,
                 imputation_method='ffill',
...
def build_dataset(model_type, sampler_name, data, depth, step):
    ...
    elif model_type in ['gru', 'rnn', 'odernn', 'gru-dt', 'gru-d', 'odelstm', 'multilayerlsdm']:
